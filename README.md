...
#### 🌱 Сейчас я обучаюсь:
- Продвинутой бэкенд-разработке на **PHP**, **Java** и мобильной на **Kotlin**.
...
- **[Site irkpo-events](https://github.com/Ximelay/irkpo-events):** сайт для управления мероприятиями в ИРКПО. Написан на Laravel с использованием современных web-стандартов разработки web-приложений.
